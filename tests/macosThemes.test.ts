...
assert.match(style, /html\[data-app-theme="macosDark"\][\s\S]*--theme-accent:\s*#75b8d4;/);
assert.match(style, /html\[data-app-theme="macosDark"\][\s\S]*--accent-bg:\s*#2c6884;/);
assert.match(style, /html\[data-app-theme="macosDark"\][\s\S]*--accent-text:\s*#a9dbef;/);
assert.match(style, /html\[data-app-theme="macosDark"\][\s\S]*--clipboard-card-link-text:\s*#a9dbef;/);
